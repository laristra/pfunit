...
!-------------------------------------------------------------------------------
!  MODULE: ExpectationPolyWrapVector
!
!> @brief
!! <BriefDescription>
!!
...
module ExpectationPolyWrapVector_mod
  use ExpectationPolyWrap_mod, only: ExpectationPolyWrap
  use Expectation_mod, only: Expectation
   
   implicit none
   private

   public :: ExpectationPolyWrapVector
   public :: ExpectationPolyWrapVectorIterator
   public :: ExpectationPolyWrapVectorReverseIterator
   ! external functions
   public :: swap


   integer, parameter :: UNINITIALIZED = -1
   type :: ExpectationPolyWrapVector
      private
      
      type(ExpectationPolyWrap), allocatable :: elements(:)
   ...
   end type ExpectationPolyWrapVector

   type ExpectationPolyWrapVectorIterator
      type(ExpectationPolyWrap), pointer :: elements(:) => null()
   ...
   end type ExpectationPolyWrapVectorIterator

   type ExpectationPolyWrapVectorReverseIterator
      type(ExpectationPolyWrap), pointer :: elements(:) => null()
      integer :: index = UNINITIALIZED
   contains
   ...
   end type ExpectationPolyWrapVectorReverseIterator


   interface ExpectationPolyWrapVector
      module procedure constructor_empty
   end interface ExpectationPolyWrapVector
...
contains
   ...
   function constructor_empty() result(v)
      type (ExpectationPolyWrapVector) :: v
...
!----------------------------------------------
   subroutine copyVector(this, other)
      class (ExpectationPolyWrapVector), intent(inout) :: this
      type (ExpectationPolyWrapVector), intent(in) :: other
...
!----------------------------------------------
   subroutine copyFromArray(this, array)
      class (ExpectationPolyWrapVector), intent(inout) :: this
      type(ExpectationPolyWrap), intent(in) :: array(:)
...
!----------------------------------------------
   integer function getSize(this) 
      class (ExpectationPolyWrapVector), intent(in) :: this
...
!---------------------------------------------------
   function at(this, i) result(ptr)
      class (ExpectationPolyWrapVector), target, intent(in) :: this
      integer, intent(in) :: i
      type(ExpectationPolyWrap), pointer :: ptr
...
!---------------------------------------------------
   function at_alt(this, i) result(ptr)
      class (ExpectationPolyWrapVector), target, intent(in) :: this
      integer, intent(in) :: i
      class(Expectation), pointer :: ptr

      type(ExpectationPolyWrap), pointer :: pTmp
...
!-----------------------------------------------------------------
   function data(this) result(d)
      class (ExpectationPolyWrapVector), target :: this
      type(ExpectationPolyWrap), pointer :: d(:)
...
!---------------------------------------------------
   subroutine reserve(this, n)
      ...
      type(ExpectationPolyWrap), allocatable :: tmp(:)
      integer :: i, nOld
...
!---------------------------------------------------
   subroutine resize(this, n, value)
      class (ExpectationPolyWrapVector), intent(inout) :: this
      integer, intent(in) :: n
      type(ExpectationPolyWrap), optional, intent(in) :: value
...
!---------------------------------------------------
   subroutine push_back_T(this, value)
      class (ExpectationPolyWrapVector), intent(inout) :: this
      type(ExpectationPolyWrap), intent(in) :: value
...
!---------------------------------------------------
   ...
   function erase(this, position) result(iter)
      ...
      class (ExpectationPolyWrapVector), target, intent(inout) :: this
      type (ExpectationPolyWrapVectorIterator), intent(in) :: position

      type(ExpectationPolyWrap), pointer :: p, q
...
!---------------------------------------------------
   subroutine push_back_alt(this, value)
      ...
      call this%push_back(ExpectationPolyWrap(value))
...
!---------------------------------------------------
   subroutine insert_alt(this, i, value)
      class (ExpectationPolyWrapVector), intent(inout) :: this
      integer, intent(in) :: i
      class(Expectation), intent(in) :: value

      call this%insert(i, ExpectationPolyWrap(value))
...
!---------------------------------------------------
   subroutine swapVector(this, a)
      type (ExpectationPolyWrapVector), intent(inout) :: this
      type (ExpectationPolyWrapVector), intent(inout) :: a
...
!------------------------------------------------------
   function rbegin(this) result(iter)
      class (ExpectationPolyWrapVector), target, intent(in) :: this
      type (ExpectationPolyWrapVectorReverseIterator) :: iter
...
!-----------------------------------------------------
      function get(this) result(ptr)
         type(ExpectationPolyWrap), pointer :: ptr
         class (ExpectationPolyWrapVectorIterator), intent(in) :: this
      ...
      subroutine next(this)
         class (ExpectationPolyWrapVectorIterator), intent(inout) :: this
      ...
      logical function equalIters(this, other)
         class (ExpectationPolyWrapVectorIterator), intent(in) :: this
         class (ExpectationPolyWrapVectorIterator), intent(in) :: other
      ...
      function add(this, n) result(newIter)
         type (ExpectationPolyWrapVectorIterator) :: newIter
         class (ExpectationPolyWrapVectorIterator), intent(in) :: this
         integer, intent(in) :: n
      ...
      function getRIter(this) result(ptr)
         class (ExpectationPolyWrapVectorReverseIterator), intent(in) :: this
         type(ExpectationPolyWrap), pointer :: ptr
      ...
      subroutine rNext(this)
         class (ExpectationPolyWrapVectorReverseIterator), intent(inout) :: this
         this%index = this%index - 1
      ...
      logical function equalRIters(this, other)
         class (ExpectationPolyWrapVectorReverseIterator), intent(in) :: this
         class (ExpectationPolyWrapVectorReverseIterator), intent(in) :: other
...
end module ExpectationPolyWrapVector_mod
