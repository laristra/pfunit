...
module EventPolyWrapVector_mod
      use EventPolyWrap_mod, only: EventPolyWrap
         use Event_mod, only: Event
   
   implicit none
   private

   public :: EventPolyWrapVector
   public :: EventPolyWrapVectorIterator
   public :: EventPolyWrapVectorReverseIterator
   ! external functions
   public :: swap


   integer, parameter :: UNINITIALIZED = -1
   type :: EventPolyWrapVector
      private
      
      type(EventPolyWrap), allocatable :: elements(:)
   ...
   end type EventPolyWrapVector

   type EventPolyWrapVectorIterator
      type(EventPolyWrap), pointer :: elements(:) => null()
   ...
   end type EventPolyWrapVectorIterator

   type EventPolyWrapVectorReverseIterator
      type(EventPolyWrap), pointer :: elements(:) => null()
      integer :: index = UNINITIALIZED
   contains
   ...
   end type EventPolyWrapVectorReverseIterator


   interface EventPolyWrapVector
      module procedure constructor_empty
   end interface EventPolyWrapVector
...
!----------------------------------------------
   subroutine copyVector(this, other)
      class (EventPolyWrapVector), intent(inout) :: this
      type (EventPolyWrapVector), intent(in) :: other
...
!----------------------------------------------
   subroutine copyFromArray(this, array)
      class (EventPolyWrapVector), intent(inout) :: this
      type(EventPolyWrap), intent(in) :: array(:)
...
!----------------------------------------------
   integer function getSize(this) 
      class (EventPolyWrapVector), intent(in) :: this
...
!---------------------------------------------------
   function at(this, i) result(ptr)
      class (EventPolyWrapVector), target, intent(in) :: this
      integer, intent(in) :: i
      type(EventPolyWrap), pointer :: ptr
...
!---------------------------------------------------
   function at_alt(this, i) result(ptr)
      class (EventPolyWrapVector), target, intent(in) :: this
      integer, intent(in) :: i
      class(Event), pointer :: ptr

      type(EventPolyWrap), pointer :: pTmp
...
!-----------------------------------------------------------------
   function data(this) result(d)
      class (EventPolyWrapVector), target :: this
      type(EventPolyWrap), pointer :: d(:)
...
!---------------------------------------------------
   subroutine reserve(this, n)
      ...
      type(EventPolyWrap), allocatable :: tmp(:)
      integer :: i, nOld
...
!---------------------------------------------------
   subroutine resize(this, n, value)
      class (EventPolyWrapVector), intent(inout) :: this
      integer, intent(in) :: n
      type(EventPolyWrap), optional, intent(in) :: value
...
!---------------------------------------------------
   subroutine push_back_T(this, value)
      class (EventPolyWrapVector), intent(inout) :: this
      type(EventPolyWrap), intent(in) :: value
...
!---------------------------------------------------
   ...
   function erase(this, position) result(iter)
      ...
      class (EventPolyWrapVector), target, intent(inout) :: this
      type (EventPolyWrapVectorIterator), intent(in) :: position

      type(EventPolyWrap), pointer :: p, q
...
!---------------------------------------------------
   subroutine push_back_alt(this, value)
      ...
      call this%push_back(EventPolyWrap(value))
...
!---------------------------------------------------
   subroutine insert_alt(this, i, value)
      class (EventPolyWrapVector), intent(inout) :: this
      integer, intent(in) :: i
      class(Event), intent(in) :: value

      call this%insert(i, EventPolyWrap(value))
...
!---------------------------------------------------
   subroutine swapVector(this, a)
      type (EventPolyWrapVector), intent(inout) :: this
      type (EventPolyWrapVector), intent(inout) :: a
...
!------------------------------------------------------
   function rbegin(this) result(iter)
      class (EventPolyWrapVector), target, intent(in) :: this
      type (EventPolyWrapVectorReverseIterator) :: iter
...
!-----------------------------------------------------
      function get(this) result(ptr)
         type(EventPolyWrap), pointer :: ptr
         class (EventPolyWrapVectorIterator), intent(in) :: this
      ...
      subroutine next(this)
         class (EventPolyWrapVectorIterator), intent(inout) :: this
      ...
      logical function equalIters(this, other)
         class (EventPolyWrapVectorIterator), intent(in) :: this
         class (EventPolyWrapVectorIterator), intent(in) :: other
      ...
      function add(this, n) result(newIter)
         type (EventPolyWrapVectorIterator) :: newIter
         class (EventPolyWrapVectorIterator), intent(in) :: this
         integer, intent(in) :: n
      ...
      function getRIter(this) result(ptr)
         class (EventPolyWrapVectorReverseIterator), intent(in) :: this
         type(EventPolyWrap), pointer :: ptr
      ...
      subroutine rNext(this)
         class (EventPolyWrapVectorReverseIterator), intent(inout) :: this
         this%index = this%index - 1
      ...
      logical function equalRIters(this, other)
         class (EventPolyWrapVectorReverseIterator), intent(in) :: this
         class (EventPolyWrapVectorReverseIterator), intent(in) :: other
...
end module EventPolyWrapVector_mod
